...
<body  style="background-image: url(../images/certificado.png)">
    ...
    <div class="row" style="margin-left: 20px">        
            <small>Sucursal:  {{ $sucursal->su_ciudad }}</small>             
        </div>   
    <div class="row" style="margin-left: 20px">
        ...
        <table class="table table-sm table-bordered" >
            <thead >
                <tr>
                    ...
                    <th style="color:#2E519f"><small><strong>Opt/Oft</strong></small></th> 
                    <th style="color:#2E519f"><small><strong>Motivo</strong></small></th>                    
                </tr>
            </thead>
            <tbody>
                ...
                <tr>
                    ...
                    <td><small>{{ $consulta->usuario->us_nombres }} {{ $consulta->usuario->us_apellidos }}</small></td>
